...
class StartupInfoLogger {
    ...
    private static final long HOST_NAME_RESOLVE_THREHOLD=200;
    ...
    {
        String name=(this.sourceClass!=null)? ClassUtils.getShortName(this.sourceClass)
                :"application";
        message.append(name);
    }
    private void appendOn(StringBuilder message)
    {
        ...
        if(resolveTime>HOST_NAME_RESOLVE_THREHOLD){
