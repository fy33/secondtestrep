...
public class SpringApplication {
    ...
    private void callRunners(ApplicationContext context, ApplicationArguments args) {
        ...
        for (Object runner : new LinkedHashSet<>(runners)) {
            if (runners instanceof ApplicationRunner) {
    ...
    protected void load(ApplicationContext context,Object[] sources) {
        ...
        BeanDefinitionLoader loader = this.createBeanDefinitionLoader(this.
    ...
    {
        return this.mainApplicationClass==null?logger:
                LogFactory.getLog(this.mainApplicationClass);
    }
    ...
    protected void postProcessApplicationContext(ConfigurableApplicationContext context)
    {
        ...
        {
            context.getBeanFactory().registerSingleton("org.springframework.context.annotation.internalConfigurationBeanNameGenerator",
...
//    }
    private Banner printBanner(ConfigurableEnvironment environment)
    {
        if(this.bannerMode== Banner.Mode.OFF)
        {
            ...
            SpringApplicationBannerPrinter bannerPrinter=new SpringApplicationBannerPrinter(
                    (ResourceLoader)resourceLoader,this.banner
            );
            return this.bannerMode == Banner.Mode.LOG ? bannerPrinter.print(environment,
                    this.mainApplicationClass, logger) : bannerPrinter.print(environment,
    ...
    private ConfigurableEnvironment prepareEnvironment(SpringApplicationRunListeners listeners,
        ...
        if (!this.isCustomEnvironment) {
            environment = (new EnvironmentConverter(this.getClassLoader()))
                    .convertEnvironmentIfNecessary((ConfigurableEnvironment) environment,
                                            ...
                                            String[] args)
    {
        ...
        {
            sources.addLast(new MapPropertySource("dafaultProperties",this.defaultProperties));
        }
